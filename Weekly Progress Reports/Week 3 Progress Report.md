...
|----------|----------|----------|----------|
| Jessica Becerra | 5 | -Provided Frustration Report <br> - Downloaded the data files from World Bank | My biggest challenge this week was getting the data properly download to my computer and also previwieng it to nake sure that everything that needed to be in it was included. |
