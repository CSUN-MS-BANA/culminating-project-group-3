...
| Angelica Verduzco |6 hours|- Proposed selected indicators for step 1 
Introduced an additional database (Gender Statistics) in step 3 and selected indicators that align with our inital database <br> - Created an initial draft of ERD <br> Created 15 research questions that aligns with our focus | A challenge I faced is looking for a database that related to our inital selection with recent data|
